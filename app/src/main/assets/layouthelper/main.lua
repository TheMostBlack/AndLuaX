...
_ids.editor.setBasewordColor(tonumber(ab))--基词
_ids.editor.setPanelBackgroundColor(tonumber(abc))--卡片颜色
_ids.editor.setPanelTextColor(tonumber(abcd))--卡片字体颜色
_ids.editor.setStringColor(tonumber(abcde))--字符串颜色
_ids.editor.setTextColor(tonumber(abcdef))--文本颜色
_ids.editor.setUserwordColor(tonumber(abcdefg))--数字
_ids.editor.setCommentColor(tonumber(abcdefgh))--注释颜色
_ids.editor.setKeywordColor(tonumber(abcdefghi))--if then等
