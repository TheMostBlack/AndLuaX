...
function query(self,...)
  ...
  Http.get("https://api2.bmob.cn/1/classes/"..t,header(self),function(code,json)
...
function insert(self,t,d,c)
  ...
  Http.post("https://api2.bmob.cn/1/classes/"..t,d,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function update(self,t,i,d,c)
  ...
  Http.put("https://api2.bmob.cn/1/classes/"..t.."/"..i,d,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function delete(self,t,i,c)
  Http.delete("https://api2.bmob.cn/1/classes/"..t.."/"..i,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function upload(self,f,c)
  f=File(f)
  Http.HttpTask("https://api2.bmob.cn/2/files/"..f.Name,"POST",nil,nil,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function remove(self,i,c)
  Http.delete("https://api2.bmob.cn/2/files/"..i,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function sign(self,u,p,e,c)
  ...
  Http.post("https://api2.bmob.cn/1/users",d,header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
    end
    c(code,json)
...
function login(self,u,p,c)
  Http.get("https://api2.bmob.cn/1/login/?username="..decode(u).."&password="..decode(p),header(self),function(code,json)
    if code~=-1 and code>=200 and code<400 then
      json=cjson.decode(json)
