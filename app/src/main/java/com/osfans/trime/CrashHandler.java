...
public class CrashHandler implements UncaughtExceptionHandler {
     ...
     * @param userDataDir
     */
    public void init(Context context, String userDataDir) {
        mContext = context;
        mDir=new File(userDataDir,"logs").getAbsolutePath();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        Log.i(TAG, "saveCrashInfo2File: "+ex);
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                FileOutputStream fos = new FileOutputStream(new File(mDir, fileName));
